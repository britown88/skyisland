...
void Init(void)
{
  ...
  if (GLWindow::instance().init("Sky Island Game") != GL_TRUE)
    Shut_Down(1);
  // 800 x 600, 16 bit color, no depth, alpha or stencil buffers, windowed
  if (GLWindow::instance().open(window_width, window_height, false) != GL_TRUE)
    Shut_Down(1);
